...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Canvas = __webpack_require__(93);
	...
	new _Canvas2.default('.canvas', '.video').init('.js-btn__v-start', '.js-btn__v-stop', '.js-btn__v-save');
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* global $ */
	var Canvas = function () {
		function Canvas(canvasEl, videobEl) {
		...
		(0, _createClass3.default)(Canvas, [{
			...
			value: function initBehavior() {
				...
				this.btnStart.on('click', function () {
					if (_this.videoEl[0].paused) {
						_this.videoEl[0].play();
						_this.draw(_this.videoEl[0], _this.context, _this.videoEl.width(), _this.videoEl.height());
					}
				});
	
				this.btnStop.on('click', function () {
					if (!_this.videoEl[0].paused) {
						_this.videoEl[0].pause();
				...
				this.btnSave.on('click', function () {
					var dataURL = $(_this.canvas)[0].toDataURL();
					document.querySelector('.sketcher__screenshot').src = dataURL;
				});
			}
		}, {
			key: 'draw',
			value: function draw(v, c, w, h) {
